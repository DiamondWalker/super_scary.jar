...
public class VisageRenderer extends EntityRenderer<EntityVisage> {
    ...
    public void render(EntityVisage entity, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        ...
        vertex(vertexconsumer, pose, p_114085_, -1.0f, -1.0f + 0.7f, entity.animationHelper.u1(), entity.animationHelper.v2(), 1.0f);
        vertex(vertexconsumer, pose, p_114085_, 1.0f, -1.0f + 0.7f, entity.animationHelper.u2(), entity.animationHelper.v2(), 1.0f);
        vertex(vertexconsumer, pose, p_114085_, 1.0f, 1.0f + 0.7f, entity.animationHelper.u2(), entity.animationHelper.v1(), 1.0f);
        vertex(vertexconsumer, pose, p_114085_, -1.0f, 1.0f + 0.7f, entity.animationHelper.u1(), entity.animationHelper.v1(), 1.0f);
        p_114083_.popPose();
