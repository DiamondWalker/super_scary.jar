...
public class ImprovedMeleeAttackGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        if (i - this.lastCanUseCheck < 20L) {
            ...
            if (livingentity == null) {
                ...
                if (path == null && mob.getNavigation().canUpdatePath()) this.lastCanUseCheck = i; // only if there is no path will we delay
